...
meta:
	ADDON_NAME = ofxParticleSet
	ADDON_DESCRIPTION = Manage a set of 2D particles that can interact with each other
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/smeyfroi/ofxParticleSet
